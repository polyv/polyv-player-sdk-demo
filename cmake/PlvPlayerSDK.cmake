...
if(MSVC)
    if (CMAKE_CL_64)
		...
		set(PLAYER_SDK_PATH ${CMAKE_BINARY_DIR}/plv-player-sdk/x64)
    else()
        set(DOWNLOAD_SDK_URL https://soft.polyv.net/soft/VodPCPlayer/PCPlayerSDK/${PLV_PLAYER_SDK_VERSION}/Win/PCPlayerSDK-Win-x86.7z )
		set(PLAYER_SDK_PATH ${CMAKE_BINARY_DIR}/plv-player-sdk/x86)
    endif()
elseif(APPLE)
    if (CMAKE_OSX_ARCHITECTURES MATCHES "arm64")
        set(DOWNLOAD_SDK_URL https://soft.polyv.net/soft/VodPCPlayer/PCPlayerSDK/${PLV_PLAYER_SDK_VERSION}/Mac/PCPlayerSDK-Mac-arm64.zip )
		set(PLAYER_SDK_PATH ${CMAKE_BINARY_DIR}/plv-player-sdk/arm64)
    else()
        set(DOWNLOAD_SDK_URL https://soft.polyv.net/soft/VodPCPlayer/PCPlayerSDK/${PLV_PLAYER_SDK_VERSION}/Mac/PCPlayerSDK-Mac-x86_64.zip )
		set(PLAYER_SDK_PATH ${CMAKE_BINARY_DIR}/plv-player-sdk/x86_64)
    endif()
endif()
