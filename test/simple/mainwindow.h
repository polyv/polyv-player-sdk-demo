...
private slots:
	...
	void on_seekToEndPushButton_clicked();
	...
	void on_subtitleComboBox_currentIndexChanged(int index);
	void on_subtitlePushButton_clicked();
...
private:
	...
	QString subtitleStart;
	QString subtitleStop;
	//custom render
